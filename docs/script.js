...
//actual field size(320px) divided by corresponding bodypart size(8px)
var gameFieldRelativeWidth = 39;
var gameFieldRelativeHeight = 39;
...
function startGame() {
	...
	snake.onCrash(snakeCrashHandler,{xPos:312,yPos:312});
	drawSnake();
